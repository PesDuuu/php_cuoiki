...
if (isset($_GET['cart_id'])) {
	$cart_id = $_GET['cart_id']; // Lấy catid trên host
	$delcart = $ct->del_product_cart($cart_id); // hàm check delete Name khi submit lên
}
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
	...
	if ($quantity <= $product_remain) {
		$update_quantity_cart = $ct->update_quantity_Cart($cart_id, $quantity); // hàm check catName khi submit lên
