         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input name="product_name" value="<?php echo $result_product['product_name'] ?>" type="text" class="medium" />
                    </td>
                </tr>
                  <tr>
                    <td>
                 ...
                 <tr>
                    ...
                    <td>
                        <input name="product_quantity" value="<?php echo $result_product['product_quantity'] ?>" type="text" class="medium" />
                    </td>
                </tr>
